...
# # Add a text input box for querying the data
# query = st.text_input("Ask a question about your data:")

# if query:
#     # Call the query_file API endpoint with the user's question
#     query_response = requests.post(f"{API_URL}/query_file/", json={"query": query})
...
if uploaded_file is not None:
    ...
    # Move text_input outside of button
    target_column = st.text_input("Enter target column for prediction:")
